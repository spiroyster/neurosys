...
int main(int argc, char** argv)
{
    neurosys::network net(
		neurosys::input(2),
		{ neurosys::layer(2,neurosys::activation::tanh, 1.0) },
		neurosys::output(1, neurosys::activation::tanh, 1.0)
	);
	...
	{
		net = neurosys::epoch(net, inputs, expected, neurosys::loss::function::squaredError, 0.1, [&cost](double C){ cost = C;});
